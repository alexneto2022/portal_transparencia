            ...
            <ul class="list-unstyled components" style="padding-top: 0px;">
                ...
                <li class="nav-item dropdown {{ (\Request::route()->getName() == 'transparenciaContratoGestao') ? 'active' : '' }}">
                    ...
                    <div class="dropdown-menu list-unstyled" aria-labelledby="contratos">
                        ...
                        <a href="{{route('transparenciaContratoGestao', ['id' => $unidade->id, 'escolha' => 'UPAE BELO JARDIM'])}}" style="font-size: 10px !important;">UPAE BELO JARDIM</a>
                        @endif
                ...
                <a href="{{route('transparenciaCovenio', $unidade->id)}}" style="font-size: 10px;">CONVÊNIO</a>
                </li>
                @endif
                @if($unidade->id == 1 || $unidade->id == 9)
               ...
               <!--<li class="{{ (\Request::route()->getName() == 'transparenciaManual') ? 'active' : '' }}">
				...
				@if(Auth::check())
				<li>
                    <a href="{{route('paginaContratacaoServicos', $unidade->id)}}" style="font-size: 12px;">Contração de Servicos</a>
                </li>
                @endif
            </ul>
