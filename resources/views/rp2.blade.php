...
@section('content')
<?php $hoje = date('Y-m-d'); ?>
@if((($contratacao_servicos[0]->prazoInicial <= $hoje && $contratacao_servicos[0]->prazoFinal >= $hoje)||($contratacao_servicos[0]->prazoFinal == "" && $contratacao_servicos[0]->prazoProrroga == "")) == true)
