				...
				<div class="card">
					<div class="card-header" id="headingThree">
						<h2 class="mb-0">
							...
							@if(Auth::check())
							<a href="{{route('transparenciaContratacao', array($unidade->id))}}" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> Voltar <i class="fas fa-undo-alt"></i> </a>
											...
											<table class="table table-hover table-sm">
												...
												<tbody>
													...
													<tr>
														...
														<td> <a class="btn btn-info btn-sm" style="color: #FFFFFF;" href="{{route('alterarContratos', array($unidade->id, $contrato->id, $contrato->ID))}}"><i class="fas fa-edit"></i></a> </td>
														<td> <a class="btn btn-info btn-sm" style="color: #FFFFFF;" href="{{route('responsavelCadastro', array($unidade->id, $contrato->ID))}}"> <i class="fas fa-check"></i></a> </td>
														<td> <a class="btn btn-danger btn-sm" style="color: #FFFFFF;" href="{{route('excluirContratos', array($unidade->id, $contrato->ID))}}"> <i class="fas fa-times-circle"></i></a> </td>
													</tr>
													@endif
													@endforeach
												</tbody>
