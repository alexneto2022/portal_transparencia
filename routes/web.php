...
Route::prefix('transparencia')->group(function () {
	Route::get('/{id}', 'IndexController@trasparenciaHome')->name('transparenciaHome');
...
Route::middleware(['auth'])->group(function () {
	...
	Route::get('home_compras/ordem_compra/alterar/ordemCompraAlterar/{	_id}/{id}', 'HomeController@ordemCompraAlterar')->name('ordemCompraAlterar');
	...
	Route::get('contracaoServicos/excEspContr/{idContr}/{idEsp}/{id_und}', 'ContratacaoServicosController@exclEspeContr')->name('exclEspeContr');
	...
	Route::get('contracaoServicos/exclArqErratContr/{id}/{id_und}', 'ContratacaoServicosController@exclArqErratContr')->name('exclArqErratContr');
	Route::post('contracaoServicos/exclArqErratContr/{id}/{id_und}', 'ContratacaoServicosController@exclArqErratContr')->name('exclArqErratContr');
