...
<div class="container-fluid">
  <div class="row mt-4">
    ...
    <div class="row mt-3 text-center">
        <div class="col-md-12">
            <a class="btn btn-warning btn-sm m-2" href="{{route('trasparenciaHome', $unidade->id)}}" id="Voltar" name="Voltar" type="button" style="color: #FFFFFF;"> Voltar <i class="fas fa-undo-alt"></i> </a>
